...
NAMESPACE=ibm-helm-repo-operator
...
install: ## Install all resources (CR/CRD's, RBCA and Operator)
	...
	- kubectl apply -f deploy/crds/operator.ibm.com_helmrepos_crd.yaml
	@echo ....... Applying RBAC .......
	...
	- kubectl apply -f deploy/crds/operator.ibm.com_v1alpha1_helmrepo_cr.yaml -n ${NAMESPACE}

uninstall: ## Uninstall all that all performed in the $ make install
	@echo ....... Uninstalling .......
	@echo ....... Deleting CR .......
	- kubectl delete -f deploy/crds/operator.ibm.com_v1alpha1_helmrepo_cr.yaml -n ${NAMESPACE}
	@echo ....... Deleting Operator .......
	- kubectl delete -f deploy/operator.yaml -n ${NAMESPACE}
	@echo ....... Deleting CRDs.......
	- kubectl delete -f deploy/crds/operator.ibm.com_helmrepo_crd.yaml
